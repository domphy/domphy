...
/**
 * Reverses the HTML escaping `@domphy/press` applies to fenced code content,
 ...
 * matching the shape `@domphy/press` emits:
...
/**
 * Walks a Domphy element tree (as produced by `@domphy/press`), renders every

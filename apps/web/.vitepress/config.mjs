  ...
  vite: {
    ...
    resolve: {
      alias: [
        ...
        {
          find: "@domphy/virtual",
          replacement: resolve(__dirname, "../../../packages/virtual/src"),
        },
        {
          find: "@domphy/form",
          replacement: resolve(__dirname, "../../../packages/form/src"),
        },
        {
          find: "@domphy/dnd",
          replacement: resolve(__dirname, "../../../packages/dnd/src"),
        },
        {
          find: "@domphy/palette",
          replacement: resolve(__dirname, "../../../packages/palette/src"),
        },
        {
          find: "@domphy/doctor",
          replacement: resolve(__dirname, "../../../packages/doctor/src"),
        },
      ],
    },
  },

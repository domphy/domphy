...
|---|---|---|
| `text` | `string` | Static lead-in phrase shown before the rotating word. Defaults to `"Build with"`. |
...
| `badgeColor` | `ThemeColor` | Theme color family for the badge's own elevated surface. Defaults to `"primary"`. |
| `style` | `StyleObject` | Passthrough style merged onto the outer heading line. |
| `badgeStyle` | `StyleObject` | Passthrough style merged onto the badge wrapper. |
| `className` | `string` | Extra class name merged onto the outer heading container. |

...
| `duration` | `number` | How long the draw-in animation takes, in ms. Defaults to `500`. |
...
| `padding` | `TextHighlighterPadding` | Gap in px between the text glyphs and the annotation stroke. Defaults to `5`. |

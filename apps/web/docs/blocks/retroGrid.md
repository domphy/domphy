...
|---|---|---|
| `angle` | `number` | Floor tilt, in degrees. Defaults to `65`. |
| `cellSize` | `number` | Grid spacing, in px. Defaults to `60`. |
| `opacity` | `number` | Overall grid opacity. Defaults to `0.5`. |
| `lightLineColor` | `ThemeColor` | Line color family used under a light color scheme. Defaults to `"neutral"`. |
| `darkLineColor` | `ThemeColor` | Line color family used under `prefers-color-scheme: dark`. Defaults to `"neutral"`. |

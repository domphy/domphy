...
|---|---|---|
| `variant` | `LoaderVariant` | Which single indicator to render. Omit to render a demo gallery of all five. |
| `text` | `string` | Text content for the `"shimmer"`/`"glitch"` variants. |
| `color` | `ThemeColor` | Theme color family. Defaults to `"neutral"` for every variant. |

...
| `variant` | `RainbowButtonVariant` | `"default"` fills the whole face with the animated gradient; `"outline"` keeps a neutral flat interior and only rings the border with the animated gradient. Defaults to `"default"`. |

...
const LANGUAGES: BundledLanguage[] = [
  ...
  "vue", "svelte", "markdown", "diff", "yaml", "ruby", "python", "go", "rust", "sql",
]

const ALIASES: Record<string, string> = {
  ts: "typescript", js: "javascript", sh: "bash", shell: "bash",
  zsh: "bash", md: "markdown", yml: "yaml", htm: "html", rb: "ruby", py: "python",
}
...
export async function createHighlighter(): Promise<(code: string, lang: string) => string> {

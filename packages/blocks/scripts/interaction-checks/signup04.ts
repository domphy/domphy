...
async function main() {
  ...
  const email = block.locator('[name="signup04-email"]');
  const password = block.locator('[name="signup04-password"]');
  const confirmPassword = block.locator('[name="signup04-confirm-password"]');

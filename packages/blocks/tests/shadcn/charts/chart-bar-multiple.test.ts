...
import { chartBarMultiple } from "../../../src/shadcn/charts/chart-bar-multiple.ts";
...
describe("chartBarMultiple", () => {
  it("renders a working demo tree with zero args: titled card, two-series chart, trend footer", () => {

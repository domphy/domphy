// Port addition (not in upstream @tanstack/router-core): re-export the
// history layer so consumers don't need a separate @tanstack/history install.
// Mirrors what @tanstack/react-router does in its own index.
export * from '@tanstack/history'

// Port addition: the Domphy adapter layer - framework-agnostic ports of
// @tanstack/react-router's createRouter/createRoute wrappers (no hooks,
